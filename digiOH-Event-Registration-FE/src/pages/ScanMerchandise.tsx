...
const ScanMerchandise: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gray-50 font-sans">
            <h2 className="text-2xl font-bold mb-6 text-amber-600">QR Scanner Merchandise</h2>

            <div className="bg-white p-4 rounded-3xl shadow-2xl flex flex-col items-center w-full max-w-sm border-2 border-amber-100">
                <button
                    className={`mb-4 w-full px-6 py-4 rounded-2xl font-black text-white transition-all transform active:scale-95 text-lg ${cameraOpen ? 'bg-red-500 hover:bg-red-600 shadow-red-100' : 'bg-amber-500 hover:bg-amber-600 shadow-amber-200 shadow-xl'}`}
                ...
                {!cameraOpen && (
                    <div className="w-full aspect-square bg-amber-50 rounded-2xl flex flex-col items-center justify-center text-amber-400 border-2 border-dashed border-amber-200">
